    ...
    <section className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full min-h-screen flex items-center justify-center px-4 py-16 lg:py-24">
        <div className="max-w-4xl w-full">
          ...
          {/* Tytuł */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-slate-900 mb-6 leading-tight">
            Dbaj o zdrowie
          ...
          {/* Opis */}
          <p className="text-lg md:text-xl text-slate-600 text-center mb-12 leading-relaxed max-w-2xl mx-auto">
